...
{
    if(fLiteMode) return; // ignore all Scope related functionality
...
/*
    ...
    allow endless transaction that would bloat Scope and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("scope-privatesend");
