    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Scope Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Scope address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and scope: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Scope Coin"), this);
    aboutAction->setStatusTip(tr("Show information about Scope Coin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Scope Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Scope addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Scope addresses"));
    ...
    openAction->setStatusTip(tr("Open a scope: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Scope Coin help message to get a list with possible Scope Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Scope Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Scope network", "", count));
}
...
{
    QString strTitle = tr("Scope Coin"); // default title
