    ...
    mapper(0)
{
    ...
    /* Theme selector */
    //ui->theme->addItem(QString("XSCP-light"), QVariant("light"));
    ui->theme->addItem(QString("XSCP-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("XSCP-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("XSCP-traditional"), QVariant("trad"));
