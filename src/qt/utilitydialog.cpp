    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Scope Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Scope Coin"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  scope-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Scope in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XSCP, 0.1 XSCP, 1 XSCP and 10 XSCP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://scopepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://scopepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Scope Coin is shutting down...") + "<br /><br />" +
