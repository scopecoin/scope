...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ScopeNetwork") type = ScopeNetwork;
    if(strType == "ScopeNetworkVariable") type = ScopeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ScopeNetwork) s = "ScopeNetwork";
    if(type == ScopeNetworkVariable) s = "ScopeNetworkVariable";
