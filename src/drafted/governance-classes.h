 ...
 *
 *   // network
 *   CScopeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.scope.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CScopeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ScopeNetwork
// //   -- signature requirements : Key1(User)
// class CScopeNetworkVariable : public CGovernanceObject
// {
// private:
