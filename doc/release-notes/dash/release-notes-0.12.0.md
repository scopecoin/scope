...
Scope Coin version 0.12.0 is now available from:

  https://scopepay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/scopepay/scope/issues
...
backwards-compatible with pre-0.12 versions of Scope Coin or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/scope/).
