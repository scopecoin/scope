...
Only requiring some minor changes is scope.cpp.
...
Changes to scope.cpp
----------------------
scope.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
